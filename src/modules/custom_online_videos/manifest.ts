...
export const contextualPages: RibbonPage[] = [
  {
    ...
    groups: [
      {
        id: "ctx_custom_online_videos_options",
        title: "ribbon.groups.options",
        buttons: [
          { id: `${moduleId}_add`, icon: ICONS.ACTIONS.ADD, label: "ribbon.btn.custom_online_videos_add", action: `${moduleId}_add`, color: "#27ae60" },
          { id: `${moduleId}_toggle_view`, icon: "mdi-grid-large", label: "ribbon.btn.custom_online_videos_toggle_view", action: `${moduleId}_toggle_view`, color: "#7f8c8d" },
        ],
      },
      {
