export const ICONS = {
  ...
  MUSIC: {
    BOOK: "mdi-book-music",
    BOX_MULTIPLE: "mdi-music-box-multiple",
    CIRCLE: "mdi-music-circle",
    CLEF_TREBLE: "mdi-music-clef-treble",
    FILE: "mdi-file-music-outline",
    FOLDER: "mdi-folder-music",
    MUSIC: "mdi-music",
    NOTE: "mdi-music-note",
    NOTE_EIGHTH: "mdi-music-note-eighth",
    NOTE_OFF: "mdi-music-note-off",
    NOTE_OUTLINE: "mdi-music-note-outline",
    NOTE_PLUS: "mdi-music-note-plus",
    OFF: "mdi-music-off",
    PIANO: "mdi-piano",
  ...
  PROJECTION: {
    START: "mdi-projector-screen-outline",
    STOP: "mdi-projector-screen-off-outline",
  },
  SORT: {
