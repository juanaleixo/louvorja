    ...
    groups: [
      {
        ...
        buttons: [
          ...
          },
          {
            ...
            label: "modules.bible_search.title",
            module: "bible_search",
            color: "#16a085",
          },
        ],
      ...
      },
      {
        ...
        buttons: [
          ...
          },
          {
            ...
            action: "hymnal_no_audio",
            color: "#7f8c8d",
          },
          {
            id: "sequence",
            icon: "mdi-format-list-numbered",
            label: "ribbon.btn.play_all",
            action: "hymnal_sequence",
            color: "#9b59b6",
          },
        ],
      },
        ...
        buttons: [
          {
            id: "go_bible",
            icon: "mdi-book-open-variant",
            label: "modules.bible_search.ribbon.go_bible",
            action: "bible_search_go_bible",
            color: "#c0392b",
          },
          {
            id: "project_current",
        ...
        buttons: [
          {
            ...
            action: "bible_search_toggle_format",
            color: "#1b4f8a",
          },
          {
            id: "restore",
  ...
  // ========== Busca de Música (contextual) ==========
  {
    ...
    groups: [
        ...
        buttons: [
          {
            id: "ms_filter_name",
            type: "checkbox",
            label: "modules.music_search.filter_name",
            optionKey: "modules.music_search.filter.name",
          },
          {
            id: "ms_filter_album",
            type: "checkbox",
            label: "modules.music_search.filter_album",
            optionKey: "modules.music_search.filter.album",
          },
          {
            id: "ms_filter_lyric",
            type: "checkbox",
            label: "modules.music_search.filter_lyric",
            optionKey: "modules.music_search.filter.lyric",
          },
          {
            id: "ms_filter_custom",
            type: "checkbox",
            label: "modules.music_search.filter_custom",
            optionKey: "modules.music_search.filter.custom",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        buttons: [
          {
            id: "ms_audiofile_sing",
            icon: "mdi-file-music",
            label: "ribbon.btn.sing",
            action: "music_search_audiofile_sing",
            color: "#27ae60",
          },
          {
            id: "ms_audiofile_playback",
            icon: "mdi-file-music-outline",
            label: "ribbon.btn.playback",
            action: "music_search_audiofile_playback",
            color: "#3498db",
          },
        ],
      },
